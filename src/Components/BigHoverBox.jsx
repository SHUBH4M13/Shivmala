      ...
      <div className="w-full sm:w-1/2 p-4 sm:p-6 flex flex-col justify-center gap-4">
        {heading1 && (
          <div className="flex items-center gap-3">
            ...
            <p className="uppercase  font-heading font-emphasis-heavy text-[14px] sm:text-[15px] group-hover:text-white transition-colors duration-200">
              {heading1}
            </p>
          </div>
        )}
        ...
        <div className="font-boldness font-heading text-[20px] sm:text-[24px] group-hover:text-white transition-colors duration-200">
          <p>{heading2}</p>
        </div>

        <div>
          <p className="font-body font-sans text-[16px] sm:text-[18px] text-black group-hover:text-white transition-colors duration-200">
            {heading3}
          </p>
        </div>
      </div>
