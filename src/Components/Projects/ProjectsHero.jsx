...
export default function ProjectsHero() {
    return (
        <div className="flex flex-col justify-center items-center px-4 sm:px-10 py-12">
            {/* Small Heading */}
            <div>
                <span className="font-boldness-heavy text-3xl sm:text-4xl lg:text-5xl text-[#1A1A1A] font-heading">
                    Building Tomorrow
                </span>
            </div>

            <div className="font-boldness-heavy mt-6 sm:mt-8 text-center text-[#1A1A1A] text-2xl sm:text-4xl lg:text-5xl leading-tight max-w-full whitespace-nowrap overflow-auto font-heading">
                <span>
            ...
            <div className="flex justify-center items-center mt-4 sm:mt-6 px-4">
                <p className="font-emphasis text-center text-sm sm:text-base lg:text-lg leading-relaxed max-w-2xl text-gray-800 font-sans">
