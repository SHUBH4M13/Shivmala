    ...
    <div className='flex flex-col w-full max-w-[95%] md:max-w-[700px] mx-auto px-4'>
      ...
      {text1 && (
        <div className="pt-3 sm:pt-4">
          <p
            className={`leading-relaxed whitespace-pre-line text-[16px] sm:text-[17px] md:text-[18px] font-body-medium text-gray-800 font-sans ${textalign ? textalign : 'text-left'
              }`}
          >
            {text1}
          </p>
