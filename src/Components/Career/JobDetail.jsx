  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-700 to-blue-500 text-white">
      ...
      <div className="px-4 sm:px-10 pt-10 pb-6 text-center">
        <h2 className="text-2xl sm:text-3xl font-semibold">Shivmala Engineers & Consultant</h2>
        <h1 className="text-3xl sm:text-4xl font-bold mt-2">E3D/ SP3D Instrumentation Designer</h1>
      ...
      <div className="bg-white text-black rounded-t-2xl px-4 sm:px-10 py-8">
        ...
        <div className="grid sm:grid-cols-2 gap-6 border border-blue-300 p-6 rounded-xl">
          <div>
            <p className="font-bold uppercase text-sm mb-1">Experience Required</p>
            <p className="text-gray-700 text-sm">2+ Years</p>
          </div>
          <div>
            <p className="font-bold uppercase text-sm mb-1">Educational Background</p>
      ...
      <div className="fixed bottom-5 w-full flex justify-center px-4">
        <button className="bg-white text-blue-700 font-semibold px-6 py-3 rounded-full shadow-lg hover:scale-105 transition">
