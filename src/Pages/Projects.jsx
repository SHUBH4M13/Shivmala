    ...
    <div className=' overflow-x-hidden '>      
      ...
      className="flex flex-col lg:flex-row justify-evenly items-center gap-10 mb-16 px-4">
        ...
        <div className="w-full max-w-[450px] text-center lg:text-left">
                          <h2 className="font-boldness text-3xl sm:text-4xl lg:text-5xl font-heading">Building Tomorrow</h2>
          <p className="pt-5 text-base sm:text-lg text-gray-800 font-sans">
